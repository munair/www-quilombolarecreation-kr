...
git remote add origin https://github.com/munair/www-quilombolarecreation-kr.git
...
heroku apps:destroy dev-quilombolarecreation-kr --confirm dev-quilombolarecreation-kr
heroku apps:create dev-quilombolarecreation-kr
heroku domains:add dev.quilombolarecreation.kr --app dev-quilombolarecreation-kr
heroku git:remote -a dev-quilombolarecreation-kr -r staging-heroku
